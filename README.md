...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.alaugks/spring-messagesource-base.svg?label=Maven%20Central)](https://central.sonatype.com/artifact/io.github.alaugks/spring-messagesource-base/0.2.0-SNAPSHOT)
...
```
implementation group: 'io.github.alaugks', name: 'spring-messagesource-base', version: '0.2.0-SNAPSHOT'
```
